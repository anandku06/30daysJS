...
const addTwo = (num1, num2) => {
  return num1 + num2;
}; // basic arrow function of adding two numbers

const addTwo = (num1, num2) => num1 + num2; // shorthand of arrow function when function body is of a single statement : Implicit return
// if used parenthesis then no return else return in arrow functions

const addTwo = (num1, num2) => ({ num1: num2 }); // here parenthesis involved bcz useful for returning an object if necessary
